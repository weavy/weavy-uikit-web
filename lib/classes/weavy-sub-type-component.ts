...
import { WeavyTypeComponentContextProps } from "../types/component.types";
import { WeavySubComponent } from "./weavy-sub-component";

export class WeavySubTypeComponent extends WeavySubComponent implements WeavyTypeComponentContextProps {
  // CONTEXT PROVIDERS
